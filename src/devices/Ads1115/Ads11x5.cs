...
namespace Iot.Device
{
    ...
    /// </summary>
    public class Ads1x15 : IDisposable
    {
        ...
        public Ads1x15(I2cDevice sensor, InputMultiplexer inputMultiplexer = InputMultiplexer.AIN0, MeasuringRange measuringRange = MeasuringRange.FS4096, DataRate dataRate = DataRate.SPS860)
        {
            _sensor = sensor;
